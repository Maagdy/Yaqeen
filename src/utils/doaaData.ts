export const DUAS = [
  {
    ...
    transliteration:
      "Asbahna wa asbahal mulku lillah, walhamdu lillah, la ilaha illallah wahdahu la sharika lah, lahul mulku walahul hamd, wahuwa ala kulli shay'in qadir",
    english:
      "We have reached the morning and at this very time the whole dominion belongs to Allah. All praise is due to Allah. None has the right to be worshipped except Allah, alone, without partner. To Him belongs the dominion, to Him belongs all praise and He is over all things omnipotent.",
...

  {
    ...
    transliteration:
      "Allahumma inni a'udhu bika minal 'ajzi wal kasal, wal jubni wal haram, wal bukhli wa 'adhabil qabr",
    english:
      "O Allah, I seek refuge in You from incapacity, laziness, cowardice, senility, miserliness, and the punishment of the grave.",
    reference: "Bukhari 6367",
  },
  {
    id: 5,
    category: "prayer",
...

  {
    ...
    transliteration:
      "Rabbana dhalamna anfusana wa in lam taghfir lana wa tarhamna lanakununna minal khasirin",
    english:
  ...
  },
  {
    ...
    english: "O Allah, You are Pardoning and You love pardon, so pardon me.",
    reference: "Tirmidhi 3513 — Dua of Laylatul Qadr",
  },
  {
    id: 8,
    category: "forgiveness",
    ...
    english:
      "My Lord, forgive me and accept my repentance. Verily You are the Ever-Accepting of repentance, the Most Merciful.",
  ...
  },
  {
    ...
    english:
      "None has the right to be worshipped except You. Glory be to You! Verily, I have been among the wrongdoers.",
  ...
  },
  {
    ...
    transliteration:
      "Allahummahfadhni min bayni yadayya, wa min khalfi, wa an yamini, wa an shimali, wa min fawqi, wa a'udhu bi'adhamatika an ughtala min tahti",
    english:
      "O Allah, protect me from my front, behind me, from my right, my left, and from above me. I seek refuge in Your greatness from being unexpectedly destroyed from beneath me.",
...

  {
    ...
    transliteration:
      "Rabbighfir li wa liwalidayya wa liman dakhala baytiya mu'minan wa lilmu'minina wal mu'minat",
    english:
...

  {
    ...
    transliteration:
      "Allahummakfini bihalaalika an haramik, wa aghnini bifadhlika amman siwak",
    english:
...

  {
    ...
    english:
      "All praise is due to Allah Who fed me this and provided it for me without any might or power on my part.",
  ...
  },
  {
    ...
    transliteration: "Allahumma inni as'alukal jannata wa a'udhu bika minannar",
    english:
...
export type DuaCategory = Dua["category"];

export const DUA_CATEGORIES: Record<DuaCategory, { en: string; ar: string }> = {
  morning_evening: { en: "Morning & Evening", ar: "أذكار الصباح والمساء" },
  prayer: { en: "Prayer", ar: "الصلاة" },
  forgiveness: { en: "Forgiveness", ar: "الاستغفار" },
  anxiety: { en: "Anxiety & Distress", ar: "الكرب والضيق" },
  protection: { en: "Protection", ar: "الحماية" },
  gratitude: { en: "Gratitude", ar: "الشكر" },
  knowledge: { en: "Knowledge", ar: "العلم" },
  family: { en: "Family & Parents", ar: "الأسرة والوالدين" },
  rizq: { en: "Provision & Wealth", ar: "الرزق" },
  daily: { en: "Daily Routines", ar: "الأذكار اليومية" },
  sleep: { en: "Sleep", ar: "النوم" },
  guidance: { en: "Guidance", ar: "الهداية" },
  hereafter: { en: "Hereafter", ar: "الآخرة" },
};
